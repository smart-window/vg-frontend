...
import {
  DivPartnerCompaniesTable,
  DivFilterContainer,
  DivHeaderContainer,
  DivContainer,
  DivViewingRecords,
  DivSidebar,
  DivPartnerCompaniesTableContainer,
} from './PartnerCompaniesTable.styles'
...
const partnerCompaniesGridColumnConfig = [
  {
    fieldName: 'id',
    title: 'Partner ERP ID',
    columnWidth: '15%',
    sortable: false,
  },
  {
 ...
 * @namespace PartnerCompaniesTable
 */
export default function PartnerCompaniesTable() {
  ...
  return (
    <DivContainer>
      <DivPartnerCompaniesTableContainer>
        ...
        <DivPartnerCompaniesTable data-testid='div-client-companies-table'>
          {useEmptyState ? (
            <ReportEmptyState emptyMessage={emptyMessage} />
          ) : (
            <Grid
              containerRef={gridRef}
              columnConfig={partnerCompaniesGridColumnConfig}
